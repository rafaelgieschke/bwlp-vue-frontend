...
MasterServer_serverAuthenticate_args = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.challengeResponse !== undefined &&
        args.challengeResponse !== null
      ) {
...
SatelliteServer_requestImageVersionUpload_args = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.machineDescription !== undefined &&
        args.machineDescription !== null
      ) {
...
SatelliteServer_setUploadOptions_result = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.imcyborgbutthatsok !== undefined &&
        args.imcyborgbutthatsok !== null
      ) {
          ...
          if (ftype == Thrift.Type.MAP) {
            ...
            for (let _i234 = 0; _i234 < _size232; ++_i234) {
              if (_i234 > 0) {
                if (
                  input.rstack.length >
                  input.rpos[input.rpos.length - 1] + 1
                ) {
                  input.rstack.pop();
                }
              }
  ...
  write(output) {
    ...
    if (this.permissions !== null && this.permissions !== undefined) {
      ...
      output.writeMapBegin(
        Thrift.Type.STRING,
        Thrift.Type.STRUCT,
        Thrift.objectLength(this.permissions),
      );
...
SatelliteServer_writeLecturePermissions_args = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (args.permissions !== undefined && args.permissions !== null) {
        this.permissions = Thrift.copyMap(args.permissions, [
          LecturePermissions,
        ]);
      }
    }
...
SatelliteServerClient = class SatelliteServerClient {
  ...
  requestImageVersionUpload(
    ...
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_requestImageVersionUpload(
        userToken,
        imageBaseId,
        fileSize,
        blockHashes,
  ...
  send_requestImageVersionUpload(
    userToken,
    imageBaseId,
    fileSize,
    blockHashes,
  ...
  writeImagePermissions(userToken, imageBaseId, permissions) {
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_writeImagePermissions(
        userToken,
        imageBaseId,
        permissions,
        (error, result) => {
  ...
  setImageVersionExpiry(userToken, imageBaseId, expireTime) {
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_setImageVersionExpiry(
        userToken,
        imageBaseId,
        expireTime,
        (error, result) => {
  ...
  getImageVersionVirtConfig(userToken, imageVersionId) {
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_getImageVersionVirtConfig(
        userToken,
        imageVersionId,
        (error, result) => {
          return error ? reject(error) : resolve(result);
  ...
  setImageVersionVirtConfig(userToken, imageVersionId, meta) {
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_setImageVersionVirtConfig(
        userToken,
        imageVersionId,
        meta,
        (error, result) => {
  ...
  requestImageReplication(userToken, imageVersionId) {
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_requestImageReplication(
        userToken,
        imageVersionId,
        (error, result) => {
          return error ? reject(error) : resolve(result);
  ...
  writeLecturePermissions(userToken, lectureId, permissions) {
    const self = this;
    return new Promise((resolve, reject) => {
      self.send_writeLecturePermissions(
        userToken,
        lectureId,
        permissions,
        (error, result) => {
  ...
  write(output) {
    ...
    if (this.virtualizerOsId !== null && this.virtualizerOsId !== undefined) {
      ...
      output.writeMapBegin(
        Thrift.Type.STRING,
        Thrift.Type.STRING,
        Thrift.objectLength(this.virtualizerOsId),
      );
...
ImageBaseWrite = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.defaultPermissions !== undefined &&
        args.defaultPermissions !== null
      ) {
...
PredefinedData = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.networkExceptions !== undefined &&
        args.networkExceptions !== null
      ) {
        this.networkExceptions = Thrift.copyList(args.networkExceptions, [
          PresetNetRule,
        ]);
      }
    }
...
LectureWrite = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.hasInternetAccess !== undefined &&
        args.hasInternetAccess !== null
      ) {
      ...
      if (
        args.limitToLocations !== undefined &&
        args.limitToLocations !== null
      ) {
        this.limitToLocations = args.limitToLocations;
      }
      if (
        args.limitToAllowedUsers !== undefined &&
        args.limitToAllowedUsers !== null
      ) {
      ...
      if (
        args.presetNetworkExceptionIds !== undefined &&
        args.presetNetworkExceptionIds !== null
      ) {
        this.presetNetworkExceptionIds = Thrift.copyList(
          args.presetNetworkExceptionIds,
          [null],
        );
      }
    }
...
LectureSummary = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.isImageVersionUsable !== undefined &&
        args.isImageVersionUsable !== null
      ) {
...
LectureRead = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.presetNetworkShares !== undefined &&
        args.presetNetworkShares !== null
      ) {
        this.presetNetworkShares = Thrift.copyList(args.presetNetworkShares, [
          null,
        ]);
      }
      if (
        args.presetLdapFilters !== undefined &&
        args.presetLdapFilters !== null
      ) {
        this.presetLdapFilters = Thrift.copyList(args.presetLdapFilters, [
          null,
        ]);
      }
      if (
...
UploadOptions = class {
  constructor(args) {
    ...
    if (args) {
      if (
        args.serverSideCopying !== undefined &&
        args.serverSideCopying !== null
      ) {
...
SatelliteConfig = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.defaultImagePermissions !== undefined &&
        args.defaultImagePermissions !== null
      ) {
        this.defaultImagePermissions = new ImagePermissions(
          args.defaultImagePermissions,
        );
      }
      if (
        args.defaultLecturePermissions !== undefined &&
        args.defaultLecturePermissions !== null
      ) {
        this.defaultLecturePermissions = new LecturePermissions(
          args.defaultLecturePermissions,
        );
      }
      if (
        args.maxImageValidityDays !== undefined &&
        args.maxImageValidityDays !== null
      ) {
        this.maxImageValidityDays = args.maxImageValidityDays;
      }
      if (
        args.maxLectureValidityDays !== undefined &&
        args.maxLectureValidityDays !== null
      ) {
      ...
      if (
        args.maxConnectionsPerTransfer !== undefined &&
        args.maxConnectionsPerTransfer !== null
      ) {
        this.maxConnectionsPerTransfer = args.maxConnectionsPerTransfer;
      }
      if (
        args.maxLocationsPerLecture !== undefined &&
        args.maxLocationsPerLecture !== null
      ) {
        this.maxLocationsPerLecture = args.maxLocationsPerLecture;
      }
      if (
        args.allowLoginByDefault !== undefined &&
        args.allowLoginByDefault !== null
      ) {
      ...
      if (
        args.allowStudentDownload !== undefined &&
        args.allowStudentDownload !== null
      ) {
...
SatelliteStatus = class {
  constructor(args) {
    ...
    if (args) {
      if (
        args.availableStorageBytes !== undefined &&
        args.availableStorageBytes !== null
      ) {
...
Location = class {
  constructor(args) {
    ...
    if (args) {
      ...
      if (
        args.parentLocationId !== undefined &&
        args.parentLocationId !== null
      ) {
